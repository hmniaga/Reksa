...
function subRefresh() {
    $.ajax({
        ...
        success: function (data) {
            if (data.blnResult) {
                $("#_txtMinPctKary").data("kendoNumericTextBox").value(data.SwcFee.MinPctFeeEmployee);
                $("#_txtMinPctNonKary").data("kendoNumericTextBox").value(data.SwcFee.MinPctFeeNonEmployee);
                $("#_txtMaxPctKary").data("kendoNumericTextBox").value(data.SwcFee.MaxPctFeeEmployee);
                $("#_txtMaxPctNonKary").data("kendoNumericTextBox").value(data.SwcFee.MaxPctFeeNonEmployee);

                $("#_namaGL1").val(data.listSwcFeeGL[0].GLName);
                $("#_namaGL2").val(data.listSwcFeeGL[1].GLName);
                $("#_namaGL3").val(data.listSwcFeeGL[2].GLName);
                $("#_namaGL4").val(data.listSwcFeeGL[3].GLName);
                $("#_namaGL5").val(data.listSwcFeeGL[4].GLName);

                $("#_noGL1").val(data.listSwcFeeGL[0].GLNumber);
                $("#_noGL2").val(data.listSwcFeeGL[1].GLNumber);
                $("#_noGL3").val(data.listSwcFeeGL[2].GLNumber);
                $("#_noGL4").val(data.listSwcFeeGL[3].GLNumber);
                $("#_noGL5").val(data.listSwcFeeGL[4].GLNumber);

                $("#_officeIdNoGL2").val(data.listSwcFeeGL[1].OfficeId);
                $("#_officeIdNoGL3").val(data.listSwcFeeGL[2].OfficeId);
                $("#_officeIdNoGL4").val(data.listSwcFeeGL[3].OfficeId);
                $("#_officeIdNoGL5").val(data.listSwcFeeGL[4].OfficeId);

                $("#_percentGL1").data("kendoNumericTextBox").value(data.listSwcFeeGL[0].Percentage);
                $("#_percentGL2").data("kendoNumericTextBox").value(data.listSwcFeeGL[1].Percentage);
                $("#_percentGL3").data("kendoNumericTextBox").value(data.listSwcFeeGL[2].Percentage);
                $("#_percentGL4").data("kendoNumericTextBox").value(data.listSwcFeeGL[3].Percentage);
                $("#_percentGL5").data("kendoNumericTextBox").value(data.listSwcFeeGL[4].Percentage);
                ...
                if (data.listSwcFeeTieringNotif.length != 0) {

                    var Grid1 = $("#dataGridView1").data("kendoGrid");
                    var gridData = populateGrid(data.listSwcFeeTieringNotif);
