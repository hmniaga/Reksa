CREATE proc [dbo].[ReksaMaintainSwitchingRDB]      
/*      
 CREATED BY    :   
 CREATION DATE : 
 DESCRIPTION   :     
...
--20150821, liliana, LIBST13020, begin  
    ...
    begin  
        ...
        --if (@pmTranUnit != @pmUnitBalanceSwcOut)  
...
--20150608, liliana, LIBST13020, begin  
         ...
         select @pcTranCode, @pnTranType, @pdTranDate, @pnProdIdSwcOut, @pnProdIdSwcIn,  
             --@pnClientIdSwcOut, @pnClientIdSwcIn, 0, 0, @pcSelectedAccNo, 0,  
             @pnClientIdSwcOut, @pnClientIdSwcIn, @pnFundIdSwcOut, @pnFundIdSwcIn, @pcSelectedAccNo, @nAgentId,  
             --0, @nCurrSwcOut, 0, @pmTranUnit, @pmSwitchingFee, @pmNAVSwcOut, @pmNAVSwcIn, convert(char(8),@pdNAVValueDate,112),   
